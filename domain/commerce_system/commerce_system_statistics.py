...
class Record:
    def __init__(self, action_name: str, action_maker: str):
...
class CommerceSystemStats:
    ...
    def action_made(self, action_name: str, action_maker: str):
        self.actions[action_name].append(Record(action_name, action_maker))
    ...
    def get_action_records(self, action_name: str, time_window: TimeWindow = None):
        return self.apply_time_window_filter(self.actions[action_name], time_window)
