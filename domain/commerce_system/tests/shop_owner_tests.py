...
class TestShopOwner(unittest.TestCase):
    ...
    def test_edit_product(self):
        tost = Product("tost", 115, "tost taim", 12)
        tost2 = Product("tost2", 116, "tost2 taim", 44)
        self.shop.add_product(tost)
        self.shop.add_product(tost2)
        tost_id = self.shop.get_id("tost")
        tost2_id = self.shop.get_id("tost2")
        self.shop_owner.edit_product(tost_id, name="tost3")
        self.shop_owner.edit_product(tost2_id, name="tost4")
